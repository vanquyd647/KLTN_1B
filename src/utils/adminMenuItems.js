...
export const menuItems = [
    ...
    },
    {
        ...
        subItems: [
            { id: 'general-settings', label: 'Cài đặt chung' },
            { id: 'email-settings', label: 'Cài đặt email' },
            { id: 'payment-settings', label: 'Cài đặt thanh toán' },
            { id: 'security-settings', label: 'Bảo mật' }
        ]
    },
    {
        id: 'reports',
