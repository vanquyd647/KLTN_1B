                    ...
                    <div className="w-full md:w-3/4">
                        <div className="mb-4">
                            <h1 className="text-xl font-bold mb-2">
                                Sản phẩm mới
                                {/* {pagination?.items?.length > 0 && <span className="text-sm font-normal ml-2">({pagination.items.length} sản phẩm)</span>} */}
                            </h1>
                        </div>
                        ...
                        ) : pagination && allProducts.length > 0 ? (
                        ...
                        {!loading && allProducts?.length > 0 && currentPage < pagination?.totalPages && (
