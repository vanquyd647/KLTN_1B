    ...
    useEffect(() => {
        if (newProducts?.items && newProducts.items.length > 0) {
            if (currentPage === 1) {
                ...
                setAllProducts((prev) => [...prev, ...newProductss]);
            }
        }
    }, [newProducts.items, currentPage]);
                    ...
                    <div className="w-full md:w-3/4">
                        <div className="mb-4">
                            <h1 className="text-xl font-bold mb-2">
                                Sản phẩm mới
                                {/* {newProducts?.items?.length > 0 && <span className="text-sm font-normal ml-2">({newProducts.items.length} sản phẩm)</span>} */}
                            </h1>
                        </div>
                        ...
                        <div className="mb-6">
                            <div className="flex flex-wrap items-center justify-between gap-4">
                                <div className="text-sm text-gray-600">
                                    {newProducts?.pagination?.totalItems || 0} sản phẩm
                                </div>
                                <div className="flex items-center gap-2">
                        ...
                        ) : newProducts && allProducts.length > 0 ? (
                        ...
                        {/* Nút tải thêm */}
                        {!loading && allProducts?.length > 0 && currentPage < newProducts?.pagination?.totalPages && (
