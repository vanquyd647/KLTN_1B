(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/[root of the server]__fb568b._.js", {
...
const productApi = {
    ...
    getNewProductsByPagination: async (page, limit, sort, priceRange, colorIds)=>{
        ...
        const response = await apiClient.get(`products/new?${params.toString()}`);
        return response.data;
    },
    ...
    getFeaturedProductsByPagination: async (page, limit, sort, priceRange, colorIds)=>{
        ...
        if (priceRange) params.append('priceRange', priceRange);
        if (colorIds?.length > 0) params.append('colorIds', colorIds.join(','));
        const response = await apiClient.get(`products/featured?${params.toString()}`);
        return response.data;
    }
};
const cartApi = {
...
_s(FeaturedProducts, "4rT4UUTCjG7euBYn883SErPecGE=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$router$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useRouter"],
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$redux$2f$dist$2f$react$2d$redux$2e$mjs__$5b$client$5d$__$28$ecmascript$29$__["useDispatch"],
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$redux$2f$dist$2f$react$2d$redux$2e$mjs__$5b$client$5d$__$28$ecmascript$29$__["useSelector"]
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__fb568b._.js.map