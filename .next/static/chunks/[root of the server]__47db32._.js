(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/[root of the server]__47db32._.js", {
...
(()=>{
    const e = new Error("Cannot find module '../../utils/adminApi'");
...
const AdminDashboard = ()=>{
    ...
    const { adminInfo, roles, error } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$redux$2f$dist$2f$react$2d$redux$2e$mjs__$5b$client$5d$__$28$ecmascript$29$__["useSelector"])({
    ...
    if (adminInfo && !roles.includes('admin') && !roles.includes('superadmin')) {
...
_s(AdminDashboard, "LmJZZaWQREJpbVZ5xpNsdjOUqnM=", false, function() {
    return [
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__47db32._.js.map