...
"[project]/src/pages/onsale.js [ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
    ...
    (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react__$5b$external$5d$__$28$react$2c$__cjs$29$__["useEffect"])(()=>{
        if (pagination?.items && pagination.items.length > 0) {
            if (currentPage === 1) {
                ...
                setAllProducts(pagination.items);
            } else {
                // Nếu không, chỉ thêm các sản phẩm mới (tránh trùng lặp)
                const newProducts = pagination.items.filter((item)=>!allProducts.some((existing)=>existing.id === item.id));
                setAllProducts((prev)=>[
                        ...prev,
                        ...newProducts
                    ]);
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__a7a2ada5._.js.map