...
__turbopack_esm__({
    ...
    "fetchIndexProducts": (()=>fetchIndexProducts),
...
const fetchIndexProducts = (0, __TURBOPACK__imported__module__$5b$externals$5d2f40$reduxjs$2f$toolkit__$5b$external$5d$__$2840$reduxjs$2f$toolkit$2c$__esm_import$29$__["createAsyncThunk"])('products/fetchIndexProducts', async (_, { rejectWithValue })=>{
    try {
        const products = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$apiClient$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["productApi"].getNewProductsByPagination(1, 10);
        return products;
    } catch (error) {
        return rejectWithValue(error.response?.data || 'Failed to fetch index products');
    }
});
...
const productSlice = (0, __TURBOPACK__imported__module__$5b$externals$5d2f40$reduxjs$2f$toolkit__$5b$external$5d$__$2840$reduxjs$2f$toolkit$2c$__esm_import$29$__["createSlice"])({
    ...
    extraReducers: (builder)=>{
        ...
        builder.addCase(fetchIndexProducts.pending, (state)=>{
            state.loading = true;
            state.error = null;
        }).addCase(fetchIndexProducts.fulfilled, (state, action)=>{
            state.items = action.payload.data.products;
            state.loading = false;
        }).addCase(fetchIndexProducts.rejected, (state, action)=>{
            state.error = action.payload;
            state.loading = false;
        });
...
([__TURBOPACK__imported__module__$5b$externals$5d2f$react$2d$redux__$5b$external$5d$__$28$react$2d$redux$2c$__esm_import$29$__, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$slices$2f$productSlice$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$slices$2f$colorsSlice$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$Sidebar2$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__);
;
;
;
;
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__8f9bc3._.js.map