...
;
;
const fetchProductsByCategory = (0, __TURBOPACK__imported__module__$5b$externals$5d2f40$reduxjs$2f$toolkit__$5b$external$5d$__$2840$reduxjs$2f$toolkit$2c$__esm_import$29$__["createAsyncThunk"])('productsByCategory/fetchProductsByCategory', async ({ categoryId, page = 1, limit = 10 }, { rejectWithValue })=>{
    try {
        const data = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$apiClient$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["default"].getProductsByCategory(categoryId, page, limit);
        return data;
    } catch (error) {
        return rejectWithValue(error);
    }
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__654241._.js.map