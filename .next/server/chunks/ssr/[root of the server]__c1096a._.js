...
"[externals]/@payos/payos-checkout [external] (@payos/payos-checkout, cjs)": (function(__turbopack_context__) {

var { r: __turbopack_require__, f: __turbopack_module_context__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, n: __turbopack_export_namespace__, c: __turbopack_cache__, M: __turbopack_modules__, l: __turbopack_load__, j: __turbopack_dynamic__, P: __turbopack_resolve_absolute_path__, U: __turbopack_relative_url__, R: __turbopack_resolve_module_id_path__, b: __turbopack_worker_blob_url__, g: global, __dirname, x: __turbopack_external_require__, y: __turbopack_external_import__, m: module, e: exports, t: __turbopack_require_real__ } = __turbopack_context__;
{
const mod = __turbopack_external_require__("@payos/payos-checkout", () => require("@payos/payos-checkout"));
...
var __TURBOPACK__imported__module__$5b$externals$5d2f40$payos$2f$payos$2d$checkout__$5b$external$5d$__$2840$payos$2f$payos$2d$checkout$2c$__cjs$29$__ = __turbopack_import__("[externals]/@payos/payos-checkout [external] (@payos/payos-checkout, cjs)");
...
const PaymentPage = ()=>{
    ...
    const payOS = new __TURBOPACK__imported__module__$5b$externals$5d2f40$payos$2f$payos$2d$checkout__$5b$external$5d$__$2840$payos$2f$payos$2d$checkout$2c$__cjs$29$__["PayOS"]({
    ...
    const handlePayment = async ()=>{
        ...
        try {
            ...
            if (result.checkoutUrl) {
                ...
                // Sử dụng instance PayOS để mở trang thanh toán
                await payOS.checkout(result.checkoutUrl);
            } else {
                throw new Error('Không nhận được URL thanh toán hợp lệ từ PayOS');
            }
        } catch (error) {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__c1096a._.js.map